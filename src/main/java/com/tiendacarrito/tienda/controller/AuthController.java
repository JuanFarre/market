...
import com.tiendacarrito.tienda.service.AuthServiceImpl;
import com.tiendacarrito.tienda.service.IAuthService;
import com.tiendacarrito.tienda.token.VerificationToken;
import com.tiendacarrito.tienda.token.VerificationTokenRepository;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponseDto> signUp(@RequestBody AuthRequestDto authRequestDto) {
        try {
            ...
            String errorMessage = e.getMessage();
            AuthenticationStatus status = AuthenticationStatus.USER_NOT_CREATED;
